...
public class CobExpiracao {
  ...
  public CobExpiracao expiracao(Integer expiracao) {
   ...
   * @return expiracao
  **/
  @Schema(example = "3600", required = true, description = "Tempo de vida da cobrança, especificado em segundos a partir da data de criação (Calendario.criacao) ")
